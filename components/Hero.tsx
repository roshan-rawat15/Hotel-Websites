    ...
    <main className=" bg-primary mt-0 py-14 lg:pt-20  px-5 md:px-[1.9rem] largesceen:px-14 fourk:px-44">
      <div className="grid  md:grid-cols-3 lg:grid-cols-3 mb-14 small:mb-16 largesceen:mb-24">
        <div className="md:col-span-2 animate__animated animate__fadeInLeft">
          <h1 className="text-white-100 text-[4.5rem] small:text-[5rem] lg:text-[7.5rem] desktop:text-[5rem] heading leading-none mb-6 md:mb-8 lg:mb-14 max-md:text-center">
            Royal<span className="text-secondary inline-flex">Phoenical Hotel</span>
          </h1>
          <p className="uppercase text-xs md:text-sm desktop:text-base largesceen:text-[1.625rem] max-md:text-center text-secondary">your favourite place our family stories</p>
        ...
        <div className="h-full flex lg:flex-col justify-between md:gap-x-10 lg:gap-x-0 lg:ml-20 2xl:ml-0">
          <div className="flex justify-between">
            ...
            <button className="md:w-[45px] 2xl:w-[4.375rem] max-md:hidden p-0 m-0 border-none bg-transparent">
  <Image
    src={btn}
    alt="btn"
  ...
  />
      ...
      <div className="md:flex justify-between mt-4 lg:mt-12">
        <div className="max-md:hidden">
          <p className="text-secondary underline uppercase md:text-xs  lg:text-base 2xl:text-lg largesceen:text-[1.625rem] mb-2">+91 8565585465</p>
          <p className="text-white-100 underline uppercase md:text-xs  lg:text-base 2xl:text-lg largesceen:text-[1.625rem]">Greater Noida, Uttar Pradesh</p>
        </div>
        <div>
