...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`${scroll ? "is-sticky" : ""} bg-primary flex px-5 md:px-[1.9rem] largesceen:px-14 fourk:px-44 pt-5 justify-between items-center mb-0`}>
      ...
      <div>
        <p className="stick text-xs largesceen:text-base text-white-100 leading-none max-xl:hidden">+91 8565585465</p>
      </div>
          ...
          {toggleMenu && (
            <div className="w-full fixed top-0 right-0 h-screen">
              <div className=" overflow-hidden w-full h-full bg-primary scale-up-ver-top transition-all pt-28 pl-2 sm:pl-12 pb-3">
                ...
                <p className="text-center text-white-100 text-base xs:text-xl uppercase pt-8">+91 8565585465</p>
                <p className="text-center text-white-100 text-base xs:text-xl uppercase pt-4">Greater Noida, Uttar Pradesh</p>
